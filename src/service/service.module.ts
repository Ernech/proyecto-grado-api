...
@Module({
    imports:[TypeOrmModule.forFeature([UserEntity,JobCallEntity,AcademicTrainingEntity,ExperienceEntity,AptitudeEntity,JobFunctionEntity],DataBaseEnum.ORACLE)],
